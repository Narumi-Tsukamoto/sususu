	...
	<div class="cats">
		<div class="in">
			...
			<ul class="flex">
				...
				<li class="halo"><a class="cat_tab" href="<?php echo home_url(); ?>/creators/">ALL</a></li>
			<?php foreach( $terms as $term ) : ?>
				<li class="halo">
					<a class="cat_tab <?php echo $term->slug; ?>" href="<?php echo get_term_link( $term->term_id ); ?>"><?php echo $term->name; ?></a>
				</li>
			<?php endforeach; ?>
			</ul>
		</div>
	...
	<section class="news_cont">
		<div class="in">
			<div class="creators flex">
				<?php
					$termSlug = get_query_var('cr_type');
